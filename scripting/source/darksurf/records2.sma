...
new loaded, trying
new Float:record_time[15]
new record_time_id[15][32]
new Float:record_hangtime[15]
new record_hangtime_id[15][32]
new Float:record_speed[15]
new record_speed_id[15][32]
new Float:record_dist[15]
new record_dist_id[15][32]
new Float:record_height[15]
new record_height_id[15][32]
...
public plugin_natives() {
	...
	register_native("surf_checkrecord","surf_checkrecord_impl")
	register_native("surf_get_numrecords","surf_get_numrecords_impl")
}
